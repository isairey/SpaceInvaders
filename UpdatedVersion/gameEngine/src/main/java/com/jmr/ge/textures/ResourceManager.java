...
import com.jmr.ge.image.AtlasRegionDrawable;
import com.jmr.ge.image.Drawable;
import com.jmr.ge.image.TexturedDrawable;
...
public class ResourceManager {
	...
	public void loadFont(String id, String file, Color color, int size) throws Exception {
	...
	public BitmapFont getFont(String id, String file, Color color, int size) throws Exception {
		throw new Exception("Implementation of getFont not done.");
		/*
